...
public interface IStringsCanvas {
	public final String ANIMATION_DESC 	= "Animation"; 
	public final String BUTTON_DESC 	= "Button"; 
	public final String CIRCLE_DESC 	= "Circle"; 
	public final String JIFIMAGE_DESC 	= "Jifimage"; 
	public final String LINE_DESC 		= "Line"; 
	public final String RECT_DESC 		= "Rect"; 
